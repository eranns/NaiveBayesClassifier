...
class ModelClassifier:
    ...
    #builds up a dictionary for future use of the classifier.
    #the dictionary will hold all the probabilities in m-estimate(=2) form.
    # the dictionary is a based on tuples (feature,value,class) and the value is the probability
